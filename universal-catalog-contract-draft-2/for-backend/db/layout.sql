...
('card_details_banner','banner','t:card_details.201_banner_image',NULL,NULL,'true','{"product_code":"201"}','true',NULL,(SELECT id FROM LAYOUT_ACTIONS WHERE type='deeplink' AND value='t:card_details.201_banner_link'),NULL,(SELECT id FROM LAYOUT_WIDGETS WHERE key='card_details_banner_list'),100),
