...
CREATE TABLE PRODUCT_ISSUE_BRANCHES (
    -- Общая информация о филиалах для оформления продуктов
    ID                       NUMBER(10) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER NOCYCLE NOKEEP NOSCALE NOT NULL,
...
CREATE TABLE PRODUCT_ISSUE_BRANCHES_META (
    -- Всякая мета для общей таблицы филиалов для оформления продуктов
    ID                       NUMBER(10) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER NOCYCLE NOKEEP NOSCALE NOT NULL,
...
CREATE TABLE CARD_ISSUE_BRANCHES (
    -- Информация о филиалах специфично для оформления карточных продуктов
    ID                       NUMBER(10) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER NOCYCLE NOKEEP NOSCALE NOT NULL,
    BRANCH_ID                NUMBER(10) NULL, /** FK - PRODUCT_ISSUE_BRANCHES.ID */
...
CREATE TABLE MAPS (
    -- Вместо CARD_ISSUE_DELIVERY_MAP, делаем универсальную таблицу карт в целом
    ID                       NUMBER(10) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER NOCYCLE NOKEEP NOSCALE NOT NULL,
...
CREATE TABLE CARD_ISSUE_DELIVERY (
    -- Доставка карт может потребовать разных данных по доставке в сравнении с другими продуктами, пр. статусы, служба доставки, упаковка и тд
    ID                       NUMBER(10) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER NOCYCLE NOKEEP NOSCALE NOT NULL,
    LATITUDE                 VARCHAR(50) NULL,
    LONGITUDE                VARCHAR(50) NULL,
    ADDRESS                  VARCHAR(250) NULL,
